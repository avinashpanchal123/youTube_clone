    ...
    <div>
      <button id="search_btn">
        <yt-icon class="style-scope ytd-searchbox"
          ...
          <!--css_build_mark:video.youtube.src.web.polymer.shared.core.yt_icon.yt.icon.css.js--><!--css_build_scope:yt-icon--><!--css_build_styles:video.youtube.src.web.polymer.shared.ui.styles.yt_base_styles.yt.base.styles.css.js,video.youtube.src.web.polymer.shared.core.yt_icon.yt.icon.css.js-->
        </yt-icon>
      </button>
    </div>
